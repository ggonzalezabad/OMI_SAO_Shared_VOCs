MODULE OMSAO_integration_module
...
CONTAINS
  ...
  SUBROUTINE integration ( n, x, y, k1, k2, intval, errstat )
    ...
    ! Input variables
    ! ---------------
    INTEGER (KIND=i4),                INTENT (IN) :: n, k1, k2
    ...
    REAL    (KIND=r8), INTENT (OUT)   :: intval

    ! --------------
    ! Local variable
    ! --------------
    INTEGER (KIND=i4)                  :: locestat, locerr
    !REAL    (KIND=r8)                  :: interr
    !REAL    (KIND=r8), DIMENSION (n)   :: e, work
    !REAL    (KIND=r8), DIMENSION (3,n) :: z

    locestat = pge_errstat_ok

    locerr = 0

    intval = 0.0_r8
    ! ----------------------------------
    ! Original SLATEC DAVINT integration
    ! ----------------------------------
    !CALL DAVINT ( x(1:n), y(1:n), n, x(k1), x(k2), intval, locerr)
    !IF ( locerr /= 1 ) locestat = pge_errstat_error

    ! --------------------------
    ! Modified AVINT integration
    ! --------------------------
    CALL AVINT ( n, x(1:n), y(1:n), x(k1), x(k2), intval, locerr)
    !IF ( locerr /= 1 ) locestat = pge_errstat_error
  
    !! ------------------
    !! CSPINT integration
    !! ------------------
    !CALL cspint ( n, x(1:n), y(1:n), x(k1), x(k2), z(1:3,1:n), e(1:n), work(1:n), intval)
    !
    !! ------------------
    !! CUBINT integration
    !! ------------------
    !CALL cubint ( n, x(1:n), y(1:n), k1, k2, intval, interr )
...
END MODULE OMSAO_integration_module
