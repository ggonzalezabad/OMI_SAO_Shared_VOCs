...
!
! http://people.scs.fsu.edu/~burkardt/f_src/intlib/intlib.html
! 
! which itself seems to be a rewrite of the SLATEC (D)AVINT code.
! 
! Modifications by T.P. Kurosu (05/2007):
!
!  * Changed to MODULE layout
!  * "KIND = 8" changed to "KIND = r8", with "r8" defined below
!  * Changed all x.yD+00 to x.y_r8
!  * Changed all other x.yD+/-z to x.yE+/-z_r8
!  * Changed "end" variable to "endd" to facilitate XEmacs formatting
!
! ********************************************************************

!<NOT WORKING>  SUBROUTINE integrate_it ( n, x, y, intval, errstat )
!<NOT WORKING>  
!<NOT WORKING>    USE OMSAO_precision_module, ONLY: i4, r8
!<NOT WORKING>    USE OMSAO_errstat_module, ONLY: pge_errstat_ok, pge_errstat_warning, pge_errstat_error
!<NOT WORKING>    IMPLICIT NONE
!<NOT WORKING>  
!<NOT WORKING>    ! ---------------
!<NOT WORKING>    ! Input variables
!<NOT WORKING>    ! ---------------
!<NOT WORKING>    INTEGER (KIND=i4),                INTENT (IN) :: n
!<NOT WORKING>    REAL    (KIND=r8), DIMENSION (n), INTENT (IN) :: x, y
!<NOT WORKING>  
!<NOT WORKING>    ! ----------------
!<NOT WORKING>    ! Output variables
!<NOT WORKING>    ! ----------------
!<NOT WORKING>    INTEGER (KIND=i4), INTENT (INOUT) :: errstat
!<NOT WORKING>    REAL    (KIND=r8), INTENT (OUT)   :: intval
!<NOT WORKING>  
!<NOT WORKING>    ! --------------
!<NOT WORKING>    ! Local variable
!<NOT WORKING>    ! --------------
!<NOT WORKING>    INTEGER (KIND=i4)                  :: locestat, locerr
!<NOT WORKING>    !REAL    (KIND=r8)                  :: interr
!<NOT WORKING>    !REAL    (KIND=r8), DIMENSION (n)   :: e, work
!<NOT WORKING>    !REAL    (KIND=r8), DIMENSION (3,n) :: z
!<NOT WORKING>  
!<NOT WORKING>    errstat = pge_errstat_ok
!<NOT WORKING>    locestat = pge_errstat_ok
!<NOT WORKING>  
!<NOT WORKING>    locerr = 0
!<NOT WORKING>  
!<NOT WORKING>    intval = 0.0_r8
!<NOT WORKING>    ! ----------------------------------
!<NOT WORKING>    ! Original SLATEC DAVINT integration
!<NOT WORKING>    ! ----------------------------------
!<NOT WORKING>    !CALL DAVINT ( x(1:n), y(1:n), n, x(k1), x(k2), intval, locerr)
!<NOT WORKING>    !IF ( locerr /= 1 ) locestat = pge_errstat_error
!<NOT WORKING>  
!<NOT WORKING>    ! --------------------------
!<NOT WORKING>    ! Modified AVINT integration
!<NOT WORKING>    ! --------------------------
!<NOT WORKING>    !CALL AVINT ( n, x(1:n), y(1:n), x(1), x(n), intval, locerr)
!<NOT WORKING>    !IF ( locerr /= 1 ) locestat = pge_errstat_error
!<NOT WORKING>  
!<NOT WORKING>    ! ------------------
!<NOT WORKING>    ! CSPINT integration
!<NOT WORKING>    ! ------------------
!<NOT WORKING>    !CALL cspint ( n, x(1:n), y(1:n), x(k1), x(k2), z(1:3,1:n), e(1:n), work(1:n), intval)
!<NOT WORKING>    !
!<NOT WORKING>    ! ------------------
!<NOT WORKING>    ! CUBINT integration
!<NOT WORKING>    ! ------------------
!<NOT WORKING>    !CALL cubint ( n, x(1:n), y(1:n), k1, k2, intval, interr )
!<NOT WORKING>  
!<NOT WORKING>    RETURN
!<NOT WORKING>  END SUBROUTINE integrate_it

subroutine avint ( ntab, xtab, ytab, a, b, result, ierr )
  ...
  !
  !    Input, real ( KIND = r8 ) XTAB(NTAB), the abscissas at which the
  !    function values are given.  The XTAB's must be distinct
  !    and in ascending order.
  !
  !    Input, real ( KIND = r8 ) YTAB(NTAB), the function values,
  !    YTAB(I) = F(XTAB(I)).
  !
  !    Input, real ( KIND = r8 ) A, the lower limit of integration.  A should
  !    be, but need not be, near one endpoint of the interval
  !    (X(1), X(NTAB)).
  !
  !    Input, real ( KIND = r8 ) B, the upper limit of integration.  B should
  !    be, but need not be, near one endpoint of the interval
  !    (X(1), X(NTAB)).
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  ...
  real ( KIND = r8 ) x23
  real ( KIND = r8 ) x3
  real ( KIND = r8 ) xtab(ntab)
  real ( KIND = r8 ) ytab(ntab)
...
subroutine cadre ( func, a, b, abserr, relerr, error, result, ind )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ), external FUNC, the name of the function to be
  ...
  !    in FUNC.
  !
  !    Input, real ( KIND = r8 ) A, the lower limit of integration.
  !
  !    Input, real ( KIND = r8 ) B, the upper limit of integration.
  !
  !    Input, real ( KIND = r8 ) ABSERR, the absolute error tolerance.
  !
  !    Input, real ( KIND = r8 ) RELERR, the relative error tolerance.
  !
  !    Output, real ( KIND = r8 ) ERROR, an estimate of the absolute error.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  ...
  real ( KIND = r8 ) a
  real ( KIND = r8 ) abserr
  real ( KIND = r8 ) ait(maxtbl)
  logical aitken
  real ( KIND = r8 ), parameter :: aitlow = 1.1_r8
  real ( KIND = r8 ), parameter :: aittol = 0.1_r8
  real ( KIND = r8 ) astep
  real ( KIND = r8 ) b
  real ( KIND = r8 ) beg
  real ( KIND = r8 ) begin(mxstge)
  real ( KIND = r8 ) bma
  real ( KIND = r8 ) curest
  real ( KIND = r8 ) dif(maxtbl)
  real ( KIND = r8 ) diff
  real ( KIND = r8 ) endd      ! tpk: Changed "end" to "endd"; facilitates xemacs formatting
  real ( KIND = r8 ) ergoal
  real ( KIND = r8 ) erra
  real ( KIND = r8 ) errer
  real ( KIND = r8 ) error
  real ( KIND = r8 ) errr
  real ( KIND = r8 ) est(mxstge)
  real ( KIND = r8 ) fbeg
  real ( KIND = r8 ) fbeg2
  real ( KIND = r8 ) fend
  real ( KIND = r8 ) fextm1
  real ( KIND = r8 ) fextrp
  real ( KIND = r8 ) finis(mxstge)
  real ( KIND = r8 ) fn
  real ( KIND = r8 ) fnsize
  ...
  real ( KIND = r8 ) h2next
  real ( KIND = r8 ) h2tfex
  real ( KIND = r8 ), parameter :: h2tol = 0.15_r8
  real ( KIND = r8 ) hovn
  integer i
  integer ibeg
  ...
  real ( KIND = r8 ) sum1
  real ( KIND = r8 ) sumabs
  real ( KIND = r8 ) t(maxtbl,maxtbl)
  real ( KIND = r8 ) tabs
  real ( KIND = r8 ) tabtlm
  real ( KIND = r8 ), parameter :: tljump = 0.01_r8
  real ( KIND = r8 ) ts(2049)
  real ( KIND = r8 ) vint
  ...
  begin(1:mxstge) = 0.0_r8
  est(1:mxstge) = 0.0_r8
  finis(1:mxstge) = 0.0_r8
  ibegs(1:mxstge) = 0
  reglsv(1:mxstge) = .false.

  vint = 0.0_r8

  rn(1:4) = (/ 0.7142005_r8, 0.3466282_r8, 0.8437510_r8, 0.1263305_r8 /)
  ...
  ind = 1
  bma = abs ( b - a )
  errr = min ( 0.1_r8, max ( abs ( relerr ), 10.0_r8*rnderr) )
  erra = abs ( abserr )
  ...
  reglar = .false.
  beg = a
  fbeg = func ( beg ) / 2.0_r8
  ts(1) = fbeg
  ibeg = 1
  endd = b
  fend = func ( endd ) / 2.0_r8
  ts(2) = fend
  iend = 2
...
60 continue
  ...
  t(l,1) = t(l-1,1) / 2.0_r8 + sum1 / fn
  tabs = tabs / 2.0_r8 + sumabs / fn
  ...
  fextrp = 1.0_r8
  do i = 1, lm1
     fextrp = fextrp * 4.0_r8
     t(i,l) = t(l,i) - t(l-1,i)
     t(l,i+1) = t(l,i) + t(i,l) / ( fextrp - 1.0_r8 )
  end do
...
90 continue
  ...
  if ( abs ( 4.0_r8 - t(1,lm1) ) <= h2tol ) then
     go to 130
  end if

  if ( t(1,lm1) == 0.0_r8 ) then
     go to 120
  end if

  if ( abs ( 2.0_r8 - abs ( t(1,lm1) ) ) < tljump ) then
     go to 280
  end if
...
150 continue
  ...
  it = it + 1
  vint = step * t(l,it)
  errer = abs ( step / ( fextrp - 1.0_r8 ) * t(it-1,l))
  ...
  if ( abs ( t(it,lm1) / 4.0_r8 - fextrp ) / fextrp < aittol ) then
     fextrp = fextrp * 4.0_r8
  end if
...
210 continue
  ...
  fextrp = singnx
  singnx = 2.0_r8 * singnx
  go to 240

230 continue

  fextrp = h2next
  h2next = 4.0_r8 * h2next
...
270 continue
  ...
  if ( 2.0_r8 < l - it .and. istage < mxstge ) then
     go to 370
  end if
...
280 continue
  ...
  diff = abs ( t(1,l) ) * 2.0_r8 * fn
  go to 340

290 continue

  slope = ( fend - fbeg ) * 2.0_r8
  fbeg2 = fbeg * 2.0_r8
...
subroutine chinsp ( func, a, b, epsin, epsout, result )
  ...
  !    Input, real ( KIND = r8 ) B, the upper limit of integration.
  !
  !    Input, real ( KIND = r8 ) EPSIN, the relative error tolerance.
  !
  !    Output, real ( KIND = r8 ) EPSOUT, estimated integration error.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  ...
  real ( KIND = r8 ) a1
  real ( KIND = r8 ) a2
  real ( KIND = r8 ) acof(257)
  real ( KIND = r8 ) alf
  real ( KIND = r8 ) alfnj
  real ( KIND = r8 ) alfno
  real ( KIND = r8 ) b
  real ( KIND = r8 ) bcof(257)
  real ( KIND = r8 ) bet
  real ( KIND = r8 ) betnj
  real ( KIND = r8 ) betno
  real ( KIND = r8 ) bounds
  real ( KIND = r8 ) ccof(513)
  real ( KIND = r8 ) cof
  real ( KIND = r8 ) cofmax
  real ( KIND = r8 ) const1
  real ( KIND = r8 ) const2
  ...
  !
  const1 = 0.5_r8 * ( func ( a ) + func ( b ) )
  const2 = func ( bet )
  acof(1) = 0.5_r8 * ( const1 + const2 )
  acof(2) = 0.5_r8 * ( const1 - const2 )
  bcof(2) = acof(2)
  tend = 2.0_r8 * ( acof(1) - acof(2) / 3.0_r8 )
  !
  ...
  do i = 1, nupper
     ...
     !
     const1 = -sin ( triarg )
     const2 = 0.5_r8 * alfno / const1
     alfno = const1
     betno = const2
     gamman = 1.0_r8 - 2.0_r8 * alfno**2
     deltan = -2.0_r8 * alfno * betno
     bcof(1) = 0.0_r8
     ...
     do k = 1, ncof
        ...
        cof = 2.0_r8 * ( 2.0_r8 * etank**2 - 1.0_r8 )
        a2 = 0.0_r8
        a1 = 0.0_r8
        a0 = ccof(nhalf)
...
60   continue
     ...
     do j = 1, nhalf
        index = nn - j
        ccof(j) = 0.5_r8 * ( acof(j) + bcof(j) )
        ccof(index) = 0.5_r8 * ( acof(j) - bcof(j) )
        const1 = abs ( ccof(j) )
     ...
     !
     wmean = 0.5_r8 * ( tend + umid )
     bounds = 0.5_r8 * ( tend - umid )
     deln = 0.0_r8
     rk = 2.0_r8 * rn
     do j = 1, nhalf
        index = n + 2 - j
...
160  continue
     ...
     n = 2 * n
     rn = 2.0_r8 * rn
     hnstep = 0.5_r8 * hnstep
     triarg = 0.5_r8 * triarg

  end do

  return
end subroutine chinsp
...
subroutine class ( kind, n, alpha, beta, b, a, muzero )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ) ALPHA, BETA, parameters needed for Laguerre 
  ...
  !    calculate.
  !
  !    Input, real ( KIND = r8 ) ALPHA, the value of the ALPHA parameter,
  !    required only for Jacobi or Laguerre polynomials.
  !
  !    Input, real ( KIND = r8 ) BETA, the value of the BETA parameter,
  !    required only for Jacobi polynomials.
  !
  !    Output, real ( KIND = r8 ) B(N-1), the offdiagonal coefficients.
  !
  !    Output, real ( KIND = r8 ) A(N), the diagonal coefficients.
  !
  !    Output, real ( KIND = r8 ) MUZERO, the zero-th moment, Integral W(X) DX,
  ...
  if ( kind == 1 ) then
     ...
     do i = 1, n-1
        b(i) = real ( i, KIND = r8 ) &
             / sqrt ( 4.0_r8 * real ( i * i, KIND = r8 ) - 1.0_r8 )
     end do
     !
     !  KIND = 2:
     !
     ...
     a(1:n) = 0.0_r8
     do i = 1, n-1
        b(i) = sqrt ( real ( i, KIND = r8 ) / 2.0_r8 )
     end do
     !
     !  KIND = 5:
     !
     ...
     muzero = 2.0_r8**( alpha + beta + 1.0_r8 ) * gamma ( alpha + 1.0_r8 ) &
          * gamma ( beta + 1.0_r8 ) / gamma ( 2.0_r8 + alpha + beta )

     do i = 1, n
        a(i) = ( beta**2 - alpha**2 ) / &
             ( ( 2.0_r8 * real ( i - 1, KIND = r8 ) + alpha + beta ) &
             * ( 2.0_r8 * real ( i, KIND = r8 ) + alpha + beta ) )
     end do

     abi = 2.0_r8 + alpha + beta
     b(1) = sqrt ( 4.0_r8 * ( 1.0_r8 + alpha ) * ( 1.0_r8 + beta ) &
          / ( ( abi + 1.0_r8 ) * abi * abi ) )

     do i = 2, n-1
        abi = real ( 2 * i ) + alpha + beta
        b(i) = sqrt ( 4.0_r8 * real ( i, KIND = r8 ) &
             * ( real ( i, KIND = r8 ) + alpha ) &
             * ( real ( i, KIND = r8 ) + beta ) &
             * ( real ( i, KIND = r8 ) + alpha + beta ) / &
             ( ( abi * abi - 1.0_r8 ) * abi * abi ) )
     end do
     !
     !  KIND = 6:
     !
     ...
     muzero = gamma ( alpha + 1.0_r8 )

     do i = 1, n
        a(i) = 2.0_r8 * real ( i, KIND = r8 ) - 1.0_r8 + alpha
     end do

     do i = 1, n-1
        b(i) = sqrt ( real ( i, KIND = r8 ) * ( real ( i, KIND = r8 ) + alpha ) )
     end do
...
subroutine cspint ( ntab, xtab, ftab, a, b, y, e, work, result )
  ...
  !
  !    Input, real ( KIND = r8 ) XTAB(NTAB), contains the points at which the
  !    function was evaluated.  The XTAB's must be distinct and
  !    in ascending order.
  !
  !    Input, real ( KIND = r8 ) FTAB(NTAB), contains the tabulated values of
  !    the function, FTAB(I) = F(XTAB(I)).
  !
  !    Input, real ( KIND = r8 ) A, lower limit of integration.
  !
  !    Input, real ( KIND = r8 ) B, upper limit of integration.
  !
  !    Output, real ( KIND = r8 ) Y(3,NTAB), will contain the coefficients
  ...
  !                   + Y(3,I)*(X-XTAB(I))**3
  !
  !    Output, real ( KIND = r8 ) E(NTAB), E(I) = the definite integral from
  !    XTAB(1) to XTAB(I) of S(X).
  !
  !    Workspace, real ( KIND = r8 ) WORK(NTAB).
  !
  !    Output, real ( KIND = r8 ) RESULT, the estimated value of the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  implicit none
  ...
  real ( KIND = r8 ) term
  real ( KIND = r8 ) u
  real ( KIND = r8 ) work(ntab)
  real ( KIND = r8 ) xtab(ntab)
  real ( KIND = r8 ) y(3,ntab)
  ...
  do i = 2, ntab-1
     ...
     work(i) = 2.0_r8 * ( xtab(i-1) - xtab(i+1) ) - r * s
     s = xtab(i+1) - xtab(i)
     r = s / work(i)
  end do
  ...
  do i = 1, ntab-1
     s = xtab(i+1)-xtab(i)
     term = ((( y(3,i) * 0.25_r8 * s + y(2,i) / 3.0_r8 ) * s &
          + y(1,i) * 0.5_r8 ) * s + ftab(i) ) * s
     e(i+1) = e(i) + term
  end do
  !
  ...
  do j = 1, 2
     ...
     !
     if ( r <= xtab(1) ) then
        result = result - u * ( ( r - xtab(1) ) * y(1,1) * 0.5_r8 &
             + ftab(1) ) * ( r - xtab(1) )
        !
...
subroutine cubint ( ntab, xtab, ftab, ia, ib, result, error )
  ...
  !
  !    Input, real ( KIND = r8 ) FTAB(NTAB), contains the tabulated function
  ...
  !    NTAB.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the
  !    integral from XTAB(IA) to XTAB(IB) of the function.
  !
  !    Output, real ( KIND = r8 ) ERROR, an estimate of the error in
  !    integration.
  !
  USE OMSAO_precision_module, ONLY: r8
  implicit none
...
subroutine cubint_noerror ( ntab, xtab, ftab, ia_in, ib_in, result)

  ! This routine is like cubint, except that no error estimate is returned

  USE OMSAO_precision_module, ONLY: r8
  implicit none

  integer, intent(in) :: ntab, ia_in, ib_in
  real ( KIND = r8 ), intent(in)  :: xtab(ntab), ftab(ntab)
  real ( KIND = r8 ), intent(out) :: result

  ! Local Variables
  real ( KIND = r8 ) :: d1, d2, d3, h1, h2, h3, h4
  integer :: i, j, k, ind, it, ia, ib
  real ( KIND = r8 ) r1, r2, r3, r4, term
  ...
  do i = j, k
    ...
    if ( i <= j ) then
      ...
      if ( ia <= 1 ) then
        result = h2 * ( ftab(1) &
                       + h2 * ( 0.5_r8 * d3 &
                               - h2 * ( d2 / 6.0_r8 -(h2+h3+h3)*r3/12.0_r8)))
      end if
  ...
  !
  !  Reverse the sign of result to account for integration
  !  that proceeded from high X to low X.
  !
  if ( ind /= 1 ) then
    result = -result
...
subroutine filon_cos ( ntab, ftab, a, b, t, result )
  ...
  !
  !    Input, real ( KIND = r8 ) FTAB(NTAB), contains the value of the function
  !    at A, A+H, A+2*H, ... , B-H, B, where H = (B-A)/(NTAB-1).
  !
  !    Input, real ( KIND = r8 ) A, B, the limits of integration.
  !
  !    Input, real ( KIND = r8 ) T, the multiplier of the X argument of the cosine.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  ...
  h = ( b - a ) / real ( ntab - 1, KIND = r8 )

  theta = t * h
  sint = sin ( theta )
  cost = cos ( theta )

  if ( 6.0_r8 * abs ( theta ) <= 1.0_r8 ) then

     alpha = 2.0_r8 * theta**3 /   45.0_r8 &
          - 2.0_r8 * theta**5 /  315.0_r8 &
          + 2.0_r8 * theta**7 / 4725.0_r8

     beta =  2.0_r8            /     3.0_r8 &
          + 2.0_r8 * theta**2 /    15.0_r8 &
          - 4.0_r8 * theta**4 /   105.0_r8 &
          + 2.0_r8 * theta**6 /   567.0_r8 &
          - 4.0_r8 * theta**8 / 22275.0_r8
     ...
     alpha = ( theta**2 + theta * sint * cost &
          - 2.0_r8 * sint**2 ) / theta**3

     beta = ( 2.0_r8 * theta + 2.0_r8 * theta * cost**2 &
          - 4.0_r8 * sint * cost ) / theta**3

     gamma = 4.0_r8 * ( sint - theta * cost ) / theta**3

  end if

  c2n = sum ( ftab(1:ntab:2) * cos ( t * xtab(1:ntab:2) ) ) &
       - 0.5_r8 * ( ftab(ntab) * cos ( t * xtab(ntab) ) &
       + ftab(1) * cos ( t * xtab(1) ) )
...
subroutine filon_sin ( ntab, ftab, a, b, t, result )
  ...
  !    Input, real ( KIND = r8 ) A, B, the limits of integration.
  !
  !    Input, real ( KIND = r8 ) T, multiplier of the X argument of the sine.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  ...
  s2n = sum ( ftab(1:ntab:2) * sin ( t * xtab(1:ntab:2) ) ) &
       - 0.5_r8 * ( ftab(ntab) * sin ( t * xtab(ntab) ) &
       + ftab(1) * sin ( t * xtab(1) ) )
...
function gamma ( x )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ) X, the argument of the function.
  !
  !    Output, real ( KIND = r8 ) GAMMA, the value of the function.  The program
  ...
  real ( KIND = r8 ), parameter, dimension ( 7 ) :: c = (/ &
       -1.910444077728E-03_r8, &
       8.4171387781295E-04_r8, &
       -5.952379913043012E-04_r8, &
       7.93650793500350248E-04_r8, &
       -2.777777777777681622553E-03_r8, &
       8.333333333333333331554247E-02_r8, &
       5.7083835261E-03_r8 /)
  real ( KIND = r8 ) fact
  real ( KIND = r8 ) gamma
  integer i
  integer n
  real ( KIND = r8 ), parameter, dimension ( 8 ) :: p = (/ &
       -1.71618513886549492533811_r8, &
       2.47656508055759199108314E+01_r8, &
       -3.79804256470945635097577E+02_r8, &
       6.29331155312818442661052E+02_r8, &
       8.66966202790413211295064E+02_r8, &
       -3.14512729688483675254357E+04_r8, &
       -3.61444134186911729807069E+04_r8, &
       6.64561438202405440627855E+04_r8 /)
  logical parity
  real ( KIND = r8 ), parameter :: PI = &
       3.14159265358979323846264338327950288419716939937510_r8
  real ( KIND = r8 ), parameter, dimension ( 8 ) :: q = (/ &
       -3.08402300119738975254353e+01_r8, &
       3.15350626979604161529144e+02_r8, &
       -1.01515636749021914166146e+03_r8, &
       -3.10777167157231109440444e+03_r8, &
       2.25381184209801510330112e+04_r8, &
       4.75584627752788110767815e+03_r8, &
       -1.34659959864969306392456e+05_r8, &
       -1.15132259675553483497211e+05_r8 /)
  real ( KIND = r8 ), parameter :: SQRTPI = 0.9189385332046727417803297_r8
  real ( KIND = r8 ) sum1
  real ( KIND = r8 ) x
  real ( KIND = r8 ), parameter :: XBIG = 35.040_r8
  real ( KIND = r8 ) xden
  real ( KIND = r8 ), parameter :: XMININ = 1.18D-38
  real ( KIND = r8 ) xnum
  real ( KIND = r8 ) y
  real ( KIND = r8 ) y1
  real ( KIND = r8 ) ysq
  ...
  if ( y <= 0.0_r8 ) then
     ...
     if ( gamma /= 0.0_r8 ) then
        ...
        if ( y1 /= aint ( y1 * 0.5_r8 ) * 2.0_r8 ) then
           parity = .true.
        end if
  ...
  if ( y < epsilon ( y ) ) then
  ...
  else if ( y < 12.0_r8 ) then

     y1 = y
     !
     !  0.0_r8 < argument < 1.0_r8
     !
     if ( y < 1.0_r8 ) then
        z = y
        y = y + 1.0_r8
        !
        !  1.0_r8 < argument < 12.0, reduce argument if necessary.
        !
     else
        n = int ( y ) - 1
        y = y - real ( n, KIND = r8 )
     ...
     !
     !  Evaluate approximation for 1.0_r8 < argument < 2.0.
     !
     xnum = 0.0_r8
     xden = 1.0_r8
     do i = 1, 8
     ...
     gamma = xnum / xden + 1.0_r8
     !
     !  Adjust result for case  0.0_r8 < argument < 1.0.
     !
     if ( y1 < y ) then
        gamma = gamma / y1
        !
        !  Adjust result for case  2.0_r8 < argument < 12.0.
        !
     else if ( y < y1 ) then
...
subroutine gaus8 ( func, a, b, err, result, ierr )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ), external FUNC, name of external function to
  ...
  !
  !    Output, real ( KIND = r8 ) RESULT, the computed value of the integral.
  !
  ...
  anib = log10 ( 2.0_r8 ) * real ( k, KIND = r8 ) / 0.30102000_r8
  nbits = int ( anib )
  ...
  if ( b /= 0.0_r8 ) then
     ...
     if ( sign ( 1.0_r8, b ) * a <= 0.0_r8 ) then
        go to 10
     end if
     ...
     anib = 0.5_r8 - log ( c ) / 0.69314718_r8
     nib = int ( anib )
...
10 continue
  ...
  tol = max ( abs ( err ), 2.0_r8**(5-nbits)) / 2.0_r8
  if ( err == 0.0_r8 ) then
...
120 continue
  ...
  if ( mxl == 0 .or. abs ( ce ) <= 2.0_r8 * tol * area ) then
     go to 140
  end if
...
subroutine gaussq ( kind, norder, alpha, beta, kpts, endpts, b, xtab, &
  ...
  !
  !    Input, real ( KIND = r8 ) ALPHA, is only required for Gauss-Jacobi and
  !    Gauss-Laguerre quadrature.  Its value is ignored in other cases.
  !
  !    Input, real ( KIND = r8 ) BETA, is only required for Gauss-Jacobi
  !    quadrature.  Its value is ignored in other cases.
  !
  !    Input, integer KPTS, is normally zero.
  ...
  !
  !    Input, real ( KIND = r8 ) ENDPTS(2).
  !    If KPTS is 1 or 2, ENDPTS contains the locations of the
  !    endpoints to be fixed.
  !
  !    Workspace, real ( KIND = r8 ) B(NORDER).
  !
  !    Output, real ( KIND = r8 ) XTAB(NORDER), the nodes for the quadrature rule.
  !
  !    Output, real ( KIND = r8 ) WEIGHT(NORDER), the weights for the 
  !    quadrature rule.
  !
  USE OMSAO_precision_module, ONLY: r8
  implicit none
  ...
  real ( KIND = r8 ) alpha
  real ( KIND = r8 ) b(norder)
  real ( KIND = r8 ) beta
  real ( KIND = r8 ) endpts(2)
  real ( KIND = r8 ) gam
  integer i
  integer ierr
  integer kind
  ...
  real ( KIND = r8 ) solve
  real ( KIND = r8 ) t1
  real ( KIND = r8 ) weight(norder)
  real ( KIND = r8 ) xtab(norder)
  !
...
subroutine hiordq ( ntab, delt, y, work, result )
  ...
  !  Parameters:
  !
  !    Input, integer NTAB, number of data points.
  !
  !    Input, real ( KIND = r8 ) DELT, the spacing between the X values of the
  !    data.  The actual X values are not needed!
  !
  !    Input, real ( KIND = r8 ) Y(NTAB), the Y values of the data.
  !
  !    Work array, real ( KIND = r8 ) WORK(2*(NTAB-1)).  The actual minimum amount
  !    of workspace required is two times the number of integer
  !    divisors of NTAB-1.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximation to the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  implicit none
  ...
  real ( KIND = r8 ) sum2
  real ( KIND = r8 ) sum1
  real ( KIND = r8 ) work(2*(ntab-1))
  real ( KIND = r8 ) y(ntab)
  !
  !  Determine initial trapezoidal rule
  !
  sum1 = ( y(1) + y(ntab) ) / 2.0_r8
  j = -1
  ...
  do k = 1, ntab-1
     ...
     if ( ( ( ntab - 1 ) / k ) * k == ntab - 1 ) then
        ...
        j = j + 2
        work(j) = delt * sum2 * real ( ( ntab - 1 ) / k, KIND = r8 )
        work(j+1) = real ( ( ( ntab - 1 ) / k )**2, KIND = r8 )
        !
...
subroutine iratex ( func, a, b, epsin, epsout, result, ind )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ), external FUNC.
  ...
  !    Input, real ( KIND = r8 ) B, the upper limit of integration.
  !
  !    Input, real ( KIND = r8 ) EPSIN, the requested relative error tolerance.
  !
  !    Output, real ( KIND = r8 ) EPSOUT, an estimate of the error in the
  !    integration.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
...
subroutine monte_carlo ( func, a, b, n, result )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ), external FUNC, name of external function to be
...
subroutine plint ( ntab, xtab, ftab, a, b, result )
  ...
  !    and in ascending order.
  !
  !    Input, real ( KIND = r8 ) FTAB(NTAB), the function values, 
  !    FTAB(I) = F(XTAB(I)).
  !
  !    Input, real ( KIND = r8 ) A, the lower limit of integration.  A should
  !    be, but need not be, near one endpoint of the interval
  ...
  if ( ihi == 0 ) then
     ...
     result = 0.0_r8
     do i = ilo, ihi-1
        result = result + 0.5_r8 * ( xtab(i+1) - xtab(i) ) &
             * ( ftab(i) + ftab(i+1) )
     end do
     !
     ...
     if ( ilo == 1 ) then
        slope = ( ftab(2) - ftab(1) ) / ( xtab(2) - xtab(1) )
        fa = ftab(1) + slope * ( a - xtab(1) )
        result = result + 0.5_r8 * ( xtab(ilo) - a ) * ( fa + ftab(ilo) )
     else
     ...
     if ( ihi == ntab ) then
        slope = ( ftab(ntab) - ftab(ntab-1) ) / ( xtab(ntab) - xtab(ntab-1) )
        fb = ftab(ntab-1) + slope * ( b - xtab(ntab-1) )
        result = result + 0.5_r8 * ( b - xtab(ntab) ) * ( fb + ftab(ntab) )
     else
        slope = ( ftab(ihi+1) - ftab(ihi) ) / ( xtab(ihi+1) - xtab(ihi) )
        fb = ftab(ihi) + slope * ( b - xtab(ihi) )
        result = result + 0.5_r8 * ( b - xtab(ihi) ) * ( fb + ftab(ihi) )
     end if
...
subroutine qnc79 ( func, a, b, err, result, ierr, k )
  ...
  !    which evaluates the function at the point X.
  !
  !    Input, real ( KIND = r8 ) A, lower limit of integral.
  !
  !    Input, real ( KIND = r8 ) B, upper limit of integral.
  !
  !    Input, real ( KIND = r8 ) ERR, is a requested error tolerance.
  !    Normally pick a value, 0 < ERR < 1.0D-03.
  !
  !    Output, real ( KIND = r8 ) RESULT, computed value of the integral.
  ...
  icall = 1
  w1 = 41.0_r8 / 140.0_r8
  w2  = 216.0_r8 / 140.0_r8
  w3 = 27.0_r8 / 140.0_r8
  w4  = 272.0_r8 / 140.0_r8
  !
  !  DIGITS ( X ) = number of base 2 digits in representation of X.
  !
  nbits = int ( log10 ( 2.0_r8 ) &
       * real ( digits ( result ), KIND = r8 ) / 0.30102000 )
  ...
  nib = int ( 0.5_r8 - log ( c ) / log(2.0_r8) )
...
3 continue
  ...
  tol = max ( abs ( err ), 2.0_r8**(5-nbits) )
  if ( err == 0.0_r8 ) then
  ...
  do i = 1, 11, 2
     f(i) = func ( a + real ( i - 1, KIND = r8 ) * hh(1) )
  end do
...
5 continue
  ...
  do i = 2, 12, 2
     f(i) = func ( aa(l) + real ( i - 1, KIND = r8 ) * hh(l) )
  end do
  ...
  !
  test = min ( ae + 0.8_r8 * bank, 10.0_r8 * ae )
  !
  !  Don't ask for excessive accuracy.
  !
  test = max ( test, tol * abs ( q13 ), 0.00003_r8 * tol * area )
  !
...
30 continue
  ...
  if ( 2.0_r8 * tol * area < abs ( ce ) ) then
     ierr = 2
     write ( *, '(a)' ) ' '
...
subroutine quad ( func, a, b, abserr, relerr, nleast, nmost, work, &
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ), external FUNC, the name of the function to 
  ...
  !
  !    Workspace, real ( KIND = r8 ) WORK(NMOST+1).
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximate value of the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  ...
  fcna = func ( a )
  fcnb = func ( b )
  tabs = abs ( h ) * ( abs ( fcna ) + abs ( fcnb ) ) / 2.0_r8
  t = h * ( fcna + fcnb ) / 2.0_r8
  nx = 1
  ...
  do i = 1, nmost
     ...
     sumabs = 0.0_r8
     do j = 1, nx
        fcnxi = func ( a + h * real ( 2 * j - 1, KIND = r8 ) )
        sumabs = sumabs + abs ( fcnxi )
        sum1 = sum1 + fcnxi
     end do

     t = 0.5_r8 * t + h * sum1
     tabs = tabs / 2.0_r8 + abs ( h ) * sumabs
     work(i) = 2.0_r8 * ( t + h * sum1 ) / 3.0_r8
     ...
     if ( 1 < i ) then
        ...
        do j = 2, i
           k = i + 1 - j
           f = f * 4.0_r8
           work(k) = work(k+1) + ( work(k+1) - work(k) ) / ( f - 1.0_r8 )
        end do
        !
        ...
        if ( nleast <= i ) then
           ...
           if ( x <= 3.0_r8 * tabs * ( abs ( relerr ) + rnderr ) .or. &
                x <= 3.0_r8 * abs ( abserr ) ) then
              result = work(1)
              return
           end if
...
subroutine r8vec_even ( n, alo, ahi, a )
  ...
  !
  !    Input, real ( KIND = r8 ) ALO, AHI, the low and high values.
  !
  !    Output, real ( KIND = r8 ) A(N), N evenly spaced values.
  ...
  if ( n == 1 ) then
     ...
     do i = 1, n
        a(i) = ( real ( n - i,     KIND = r8 ) * alo   &
             + real (     i - 1, KIND = r8 ) * ahi ) &
             / real ( n     - 1, KIND = r8 )
     end do
...
subroutine rminsp ( func, a, b, epsin, epsout, iop, result )
  ...
  !    Input, real ( KIND = r8 ) B, upper limit of integration.
  !
  !    Input, real ( KIND = r8 ) EPSIN, requested relative error tolerance.
  !
  !    Output, real ( KIND = r8 ) EPSOUT, estimated achieved relative error.
  !
  ...
  real ( KIND = r8 ) a
  real ( KIND = r8 ) acof(11)
  real ( KIND = r8 ) alf
  real ( KIND = r8 ) alfnj
  real ( KIND = r8 ) alfno
  real ( KIND = r8 ) ar
  real ( KIND = r8 ) b
  real ( KIND = r8 ) bcof(nupper+1)
  real ( KIND = r8 ) bet
  real ( KIND = r8 ) betnj
  real ( KIND = r8 ) betno
  real ( KIND = r8 ) const1
  ...
  real ( KIND = r8 ) epsout
  real ( KIND = r8 ) error
  real ( KIND = r8 ), parameter :: fac1 = 0.411233516712057_r8
  real ( KIND = r8 ), parameter :: fac2 = 0.822467033441132_r8
  real ( KIND = r8 ) factor
  real ( KIND = r8 ), external :: func
  real ( KIND = r8 ) gamman
  real ( KIND = r8 ) hnstep
  ...
  n = 2
  rn = 2.0_r8
  acof(1) = 0.5_r8 * ( acof(1) + bcof(1) )
  acof(2) = acof(1) - ( acof(1) - bcof(1) ) / ( 4.0_r8 * factor - 1.0_r8 )
  !
  ...
  do i = 1, nupper
     ...
     !
     const1 = 4.0_r8 * factor
     index = i+1

     do j = 2, i+1
        tend = umid + ( umid - bcof(j-1) ) / ( const1 - 1.0_r8 )
        bcof(j-1) = umid
        umid = tend
        const1 = 4.0_r8 * const1
     end do
     ...
     do j = 1, index
        ...
        const1 = 0.5_r8 * ( acof(j) + bcof(j) )
        const2 = 0.5_r8 * abs ( ( acof(j) - bcof(j) ) / const1 )
...
subroutine simp ( func, a, b, eps, result )
  ...
  !    Input, real ( KIND = r8 ) B, the upper limit of integration.
  !
  !    Input, real ( KIND = r8 ) EPS, the requested error tolerance.
  !
  !    Output, real ( KIND = r8 ) RESULT, the approximation to the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  ...
  real ( KIND = r8 ) b
  real ( KIND = r8 ) da
  real ( KIND = r8 ) dx(maxlev)
  real ( KIND = r8 ) ep
  real ( KIND = r8 ) eps
  real ( KIND = r8 ) epsp(maxlev)
  real ( KIND = r8 ) est
  real ( KIND = r8 ) est1
  real ( KIND = r8 ) est2(maxlev)
  real ( KIND = r8 ) est3(maxlev)
  real ( KIND = r8 ) f1
  real ( KIND = r8 ) f2(maxlev)
  real ( KIND = r8 ) f3(maxlev)
  real ( KIND = r8 ) f4(maxlev)
  real ( KIND = r8 ) fa
  real ( KIND = r8 ) fb
  real ( KIND = r8 ) fbp(maxlev)
  real ( KIND = r8 ) fm
  real ( KIND = r8 ) fmp(maxlev)
  real ( KIND = r8 ), external :: func
  integer l
  integer lvl
  integer nrtr(maxlev)
  real ( KIND = r8 ) pval(maxlev,3)
  real ( KIND = r8 ) result
  real ( KIND = r8 ) sum1
  real ( KIND = r8 ) sx
  real ( KIND = r8 ) x2(maxlev)
  real ( KIND = r8 ) x3(maxlev)
...
30 continue
  ...
  dx(lvl) = da / 3.0_r8
  sx = dx(lvl) / 6.0_r8
  f1 = 4.0_r8 * func ( 0.5_r8 * dx(lvl) + a1 )
  x2(lvl) = a1 + dx(lvl)
  f2(lvl) = func ( x2(lvl) )
  x3(lvl) = x2(lvl) + dx(lvl)
  f3(lvl) = func ( x3(lvl) )
  epsp(lvl) = ep
  f4(lvl) = 4.0_r8 * func ( dx(lvl) * 0.5_r8 + x3(lvl) )
  fmp(lvl) = fm
...
subroutine simpne ( ntab, x, y, result )
  ...
  !  Parameters:
  !
  !    Input, integer NTAB, number of data points.  NTAB must be at least 3.
  !
  !    Input, real ( KIND = r8 ) X(NTAB), contains the X values of the data,
  !    in order.
  !
  !    Input, real ( KIND = r8 ) Y(NTAB), contains the Y values of the data.
  !
  !    Output, real ( KIND = r8 ) RESULT.
  ...
  do
     ...
     do i = 1, 3
        sum1 = sum1 + y(n-1+i) * del(i) &
             * ( f / 3.0_r8 - g(i) * 0.5_r8 * e + pi(i) * feints )
     end do
...
subroutine simpsn ( ntab, h, y, result )
  ...
  !  Parameters:
  !
  !    Input, integer NTAB, the number of data points.  NTAB must be at least 3.
  !
  !    Input, real ( KIND = r8 ) H, specifies the increment between the
  !    X values.  Note that the actual X values are not needed,
  !    just the constant spacing!
  !
  !    Input, real ( KIND = r8 ) Y(NTAB), the data.
  !
  !    Output, real ( KIND = r8 ) RESULT, the value of the integral
  ...
  result = y(1) + y(n) + 4.0_r8 * y(n-1)
  do i = 2, n-2, 2
     result = result + 4.0_r8 * y(i) + 2.0_r8 * y(i+1)
  end do
  result = h * result / 3.0_r8
  ...
  do i = 1, 3
     sum1 = sum1 + y(n-1+i) * del(i) * &
          ( f / 3.0_r8 - g(i) * 0.5_r8 * h**2 + pii(i) * h )
  end do

  result = result + 0.5_r8 * sum1 / h**3
...
function solve ( shift, n, a, b )
  ...
  !  Parameters:
  !
  !    Input, real ( KIND = r8 ) SHIFT, the value of the factor that multiplies
...
subroutine wedint ( ntab, h, ftab, result )
  ...
  !    divisible by 6.
  !
  !    Input, real ( KIND = r8 ) H, is the spacing between the points at which
  !    the data was evaluated.
  !
  !    Input, real ( KIND = r8 ) FTAB(NTAB), contains the tabulated data values.
  !
  !    Output, real ( KIND = r8 ) RESULT, is the approximation to the integral.
  !
  USE OMSAO_precision_module, ONLY: r8
  implicit none
  ...
  result = 3.0_r8 * h * result / 10.0_r8
