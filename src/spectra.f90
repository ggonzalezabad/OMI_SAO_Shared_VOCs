SUBROUTINE spectrum_solar ( &
  ...
  fit(1:npoints) = fit(1:npoints) * (                                                                       &
       ...
       fitvar_cal(sc4_idx) * del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints)                  + &
       fitvar_cal(sc5_idx) * del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints) )
  ...
  fit(1:npoints) = fit(1:npoints) +                                                                       &
       ...
       fitvar_cal(bl4_idx) * del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints)                + &
       fitvar_cal(bl5_idx) * del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints)*del(1:npoints)
...
SUBROUTINE spectrum_earthshine ( &
  ...
  fit(j1:j2) = fit(j1:j2) * (                                                           &
       ...
       fitvar_rad(sc4_idx) * del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2)              + &
       fitvar_rad(sc5_idx) * del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2) )
  ...
  fit(j1:j2) = fit(j1:j2)                                                           + &
       ...
       fitvar_rad(bl4_idx) * del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2)            + &
       fitvar_rad(bl5_idx) * del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2)*del(j1:j2)
